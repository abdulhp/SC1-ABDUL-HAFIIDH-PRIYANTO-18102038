        ...
        <div class="col-md-4 order-md-2 mb-4">
          ...
          <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              ...
              <a href="update_form.php?mahasiswa_id=<?php echo $mhs['mahasiswa_id']?>" type="button" class="close"><span class="fafa-pencil"></span></a>
              <a href="hapus_data.php?mahasiswa_id=<?php echo $mhs['mahasiswa_id']?>" type="button" class="close"><span class="fa fa-trash"></span></a>
            </li> 
            <?php } ?>
          </ul>
        </div>
        <div class="col-md-8 order-md-1">
          ...
          <form action="simpan_mahasiswa.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select name="kelas_id" id="Kelas" class="custom-select d-block w-100">
                    <option value="">Pilih...</option>
                    <?php foreach ($data_kelas as $kelas) {
                        if($data_select_mahasiswa['kelas_id'] == $kelas['kelas_id']) {
